...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商户基本信息表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家基础配置息表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家平台配置表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家域名配置表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家安全配置表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家访问控制表';
...
(
  ...
  CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT '商家游戏配置息表';